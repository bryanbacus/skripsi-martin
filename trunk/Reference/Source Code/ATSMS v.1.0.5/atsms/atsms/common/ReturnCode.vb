...
Namespace Common
    ...
    Public Class ReturnCode
        ...
        Public Const INVALID_TIMEOUT_SETTING As Long = 1007     ' Invalid timeout setting 
        ...
        Public Const UNKNOWN_ERROR_CHECKING_PIN_STATUS As Integer = 2016              ' Unknown error while checking PIN status 
