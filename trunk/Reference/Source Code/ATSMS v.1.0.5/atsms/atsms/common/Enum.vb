...
Namespace Common
    ...
    Public Enum EnumFlowControl
        None = Handshake.None
        RTS_CTS = Handshake.RequestToSendXOnXOff
    ...
    Public Enum EnumSMSDeleteOption
        Index = 0
        Preferred_Message_Store = 1
        Preferered_Message_Store_And_MO_Sent = 2
        Preferered_Message_Store_And_MO_Sent_Unsent = 3
        All_Messages = 4
    End Enum
