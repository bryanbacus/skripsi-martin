...
<p align="justify">
<br />
Silakan ubah How to Become Donor di sini. Untuk mendapatkan hasil yang maksimal,<br />
...
<script language="JavaScript" type="text/javascript" src="{$path_editor}/richtext.js"></script>
	<form method="post" name="editAbout" onSubmit="return submitForm();">
		...
		<br>
		<input type="submit" name="simpan" value="How to Become Donors"> <input type="button" value="Reset" onClick="javascript:window.location.href='{$refresh}'">
	</form>	
