  ...
  <form method="post">
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				...
				<td width="30%"><script>DateInput('awal', true, 'YYYY/MM/DD','{$awal}')</script></td>
				<td width="5%"><center>until</center></td>
				<td width="30%"><script>DateInput('akhir', true, 'YYYY/MM/DD','{$akhir}')</script></td>
				<td><input name="filterbtn" type="submit" id="filterbtn" value="Filter &amp; Reload"/></td>
			</tr>
		</table>
		<br>		
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<td>
					...
					<select name="search_col">
						<option value="course_id">Golf Course</option>
					</select>
    ...
    <table class="adminlist" border="1" width="100%">
      ...
      <tr>
        ...
        <td valign="top" align="center" width="5%"><a href="{$this_page}?page=gamelist&aksi2=edit&id={$gameslist[game].games_id}">edit</a></td>
				<td valign="top" align="center" width="5%"><a href="{$this_page}?page=gamelist&aksi2=delete&id={$gameslist[game].games_id}">delete</a></td>
      </tr>
      {/section}
    </table>
  {else}
...
{if $showDetail}
  <form method="post">
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td colspan="3">
					<div align="left">Member's ID : <strong>{$memberid} - {$members_desc}</strong></div>
				</td>
			</tr>
			<tr>
        ...
        <tr>
          <th width="15%">Hole <a href="{$this_page}?page=gamelist&aksi2=editscore&id={$games_id}">[edit score]</a></th>
        ...
        <tr>
          <th colspan="22">Tee Off <a href="{$this_page}?page=gamelist&amp;aksi2=firststroke&amp;id={$games_id}">[edit tee off]</a></th>
        </tr>
        <tr>
          <td>FIR</td>
        ...
        <tr>
          <th colspan="22">Rest Of Shoots <a href="{$this_page}?page=gamelist&aksi2=second_stroke&id={$games_id}">[edit shoot]</a></th>
        </tr>
        <tr>
          <td>GIR</td>
