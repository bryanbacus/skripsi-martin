 ...
 {section name=tips loop=$listTips}
  <tr>
    <td width="5">&nbsp;</td>
    <td width="75" align="left" valign="top"><a href="{$listTips[tips].link}" target="_blank"><img src="{$listTips[tips].image}" width="75" height="75" class="boardimg" border="0"></a></td>
    <td>
		<table width="100%">
			<tr>
				<td align="left"><p>{$listTips[tips].isi}</p></td>
			</tr>
			<tr>
				<td><a href="?page=tips&tipeP={$tipe}&id={$listTips[tips].id}"><img src="./images/more.png" align="right" border="0"></a></td>
			</tr>
		</table>
	</td>
    <td width="5"></td>
