...
<p align="justify">
<br />
Silakan ubah About us di sini. Untuk mendapatkan hasil yang maksimal,<br />
...
<script language="JavaScript" type="text/javascript" src="{$path_editor}/richtext.js"></script>
	<form method="post" name="editAbout" onSubmit="return submitForm();">
		...
		<br>
		<input type="submit" name="simpan" value="About us"> <input type="button" value="Reset" onClick="javascript:window.location.href='{$refresh}'">
	</form>	
