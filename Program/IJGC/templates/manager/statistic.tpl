...
{if $showList}
	...
	<table border="1" cellspacing="0" cellpadding="0" width="55%" class="adminlist">
		<tr>
			<td>Member ID</td>
			<td colspan="3">&nbsp;&nbsp;<input type="text" name="member_id"></td>
		</tr>		
		<tr>
...
{if $showStatistic}
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td style="border-bottom:solid; border-bottom:1px">Hole In One</td>
			<td style="border-bottom:solid; border-bottom:1px">:</td>
			<td style="border-bottom:solid; border-bottom:1px">{$sum_hio}</td>
		</tr>
		<tr>
