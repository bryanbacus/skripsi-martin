...
<div id="addRanks">
	...
	<form method="post" name="addMember">
		<table border="0">
			<tr>
				<td width="308" class="label"><b>{$dataUser.id}</b></td>
				<td width="3" class="texton"></td>
			  <td width="801" class="texton"><input type="hidden" name="idUnik" value="{$dataUser.id}" /></td>
			</tr>
			<tr>
				<td class="label" colspan="3">
					<table border="0" class="adminlist">
						<tr>
							<td class="label">CHILD USER</td>
							<td class="texton">:</td>
							<td class="texton"><input type="text" name="cuser" value="{$datausr.user0}" /></td>
							<td class="label">PARENT USER</td>
							<td class="texton">:</td>
							<td class="texton"><input type="text" name="puser" value="{$datausr.user1}" /></td>
						</tr>
						<tr>
							<td class="label">CHILD PASSWORD</td>
							<td class="texton">:</td>
							<td class="texton"><input type="text" name="passc" value="{$datausr.password0}" /></td>
							<td class="label">PARENT PASSWORD</td>
							<td class="texton">:</td>
							<td class="texton"><input type="text" name="passp" value="{$datausr.password1}" /></td>
						</tr>
						<tr>
							<td class="label">CHILD NAME</td>
							<td class="texton">:</td>
							<td class="texton"><input type="text" name="nama" value="{$dataUser.name}" /></td>
							<td class="label">PARENT NAME</td>
							<td class="texton">:</td>
							<td class="texton"><input type="text" name="ortu" value="{$dataUser.ortu}" /></td>
						<tr>
							<td colspan="3"></td>
							<td class="label">CP PARENT</td>
							<td class="texton">:</td>
			...
			<tr>
				...
				<td class="texton">
					<img src="{$dataUser.urlGbr}" height="100" width="100" border="1" align="top"/>
				</td>
			</tr>
			<tr>
				<td class="label" valign="top">UBAH PHOTO</td>
				<td class="texton" valign="top">:</td>
				<td class="texton">
