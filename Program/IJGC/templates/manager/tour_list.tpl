      ...
      <tr>
        ...
        <td valign="top">{$datalist[data].tour_course}</td>
				...
				<td valign="top" align="left">
					<li><a href="{$this_page}?aksi=tourlist&aksi2=edit&id={$datalist[data].tour_id}">View Detail</a></li>
					{if $datalist[data].tour_status eq 'Open'}
					<li><a href="{$this_page}?aksi=tourlist&aksi2=register&id={$datalist[data].tour_id}">Register</a></li>
					{/if}
				</td>
      </tr>
      {/section}
