 ...
 * @author Martin
 */
public class FormCourse extends Form implements CommandListener, Runnable{
    ...
    public FormCourse(MGolf midlet, Display display){
        super("Info Course");
        this.midlet = midlet;
        this.display = display;

        StringItem info = new StringItem("", "", StringItem.LAYOUT_LEFT);
        info.setText("Dapatkan informasi nilai par pada golf course yang ada dalam list");
    ...
    public void commandAction(Command c, Displayable d) {
        if(c == cmdKembali){
            ...
            switch(course.getSelectedIndex()){
                case 0:
                    this.textsms = "info;course;6";
                    break;
                case 1:
                    this.textsms = "info;course;7";
                    break;
                case 2:
                    this.textsms = "info;course;8";
                    break;
                case 3:
                    this.textsms = "info;course;9";
                    break;
                case 4:
                    this.textsms = "info;course;10";
                    break;
            }
